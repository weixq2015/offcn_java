...
<body onload="showmsg()">
    <div class="main">
        ...
        <form action="<c:url value="/stu/delete"/>" method="post">
        <table border="1" width="100%" class="tab">
            ...
            <c:forEach var="m" items="${slist}" varStatus="status">
                <tr>
                    ...
                    <td>${m.cname}</td>
                    <td>
                    <a href="<c:url value="/stu/"/>delete?id=${m.id}&pageNO=${pageNO}" class="abtn">删除</a>
                    <a href="${pageContext.request.contextPath }/stu/edit/${m.id}" class="abtn">编辑</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
