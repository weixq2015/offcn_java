    ...
    <div class="main">
        <h2 class="title"><span>个人信息</span></h2>
         <table class="table">
		        ...
		        <tr>
			        <th>类　别：</th>
			        <td><label class="label label-info" >${teacher.usertype}</label></td>
		        </tr>
		        <tr>
			        <th>工　号：</th>
		        ...
		        <tr>
			       ...
			       <td>
			           ...
			           <input type="hidden" name="usertype" value="${teacher.usertype}">
			           <input type="hidden" name="name" value="${teacher.name}">
			           <input type="hidden" name="workid" value="${teacher.workid}">			       
