...
<body onload="showmsg()">
    <div class="main">
        ...
        <form action="<c:url value="cou/delete"/>" method="post">
        <table border="1" width="100%" class="tab">
            ...
            <c:forEach var="m" items="${clist}" varStatus="status">
                <tr>
                    ...
                    <td>${m.type}</td>
                    <td>
                    <a href="<c:url value="/cou/"/>delete/?id=${m.id}" class="abtn">删除</a>
                    <a href="${pageContext.request.contextPath }/cou/showedit/${m.id}" class="abtn">编辑</a>
                    <a href="${pageContext.request.contextPath }/cou/setctc/${m.id}" class="abtn out">排课</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
